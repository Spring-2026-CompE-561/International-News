      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-sm font-medium px-3 py-1.5 rounded-md border border-gray-300 dark:border-white/30 text-gray-500 dark:text-white/60 hover:border-red-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/20 dark:hover:border-red-500/60 dark:hover:text-red-400 transition-all duration-200 cursor-pointer"
          >
