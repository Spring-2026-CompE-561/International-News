...
export function GlobeView({ markers }: Props) {
  ...
  return (
    <div className="flex flex-col lg:flex-row rounded-2xl overflow-hidden border border-gray-200 dark:border-white/[0.08]">
      {/* Globe — full sphere, centered */}
      <div className="flex-1 flex items-center justify-center bg-white dark:bg-[#0d0d0d] p-6 lg:p-10 min-h-[380px] lg:min-h-[560px] relative">
        <GlobeInteractive
          markers={markers}
          isDark={isDark}
